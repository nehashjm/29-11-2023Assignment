...
//    {
//        public delegate void OurDel(int ch);

//        public static void Spin(int ch)
//        {
//            int Energylevel = 1;
...
//            if (ch == 1)
//            {
//                Console.WriteLine($"You have entered {ch} your energy level is {Energylevel +1} and your win probility is {winprobality +10}");
//            }
//            else if (ch == 2)
//            {
//                Console.WriteLine($"You have entered {ch} your energy level is {Energylevel += 2} and your win probility is {winprobality += 20}");
//            }
//            else if (ch == 3)
//            {
//                Console.WriteLine($"You have entered {ch} your energy level is {Energylevel -= 3} and your win probility is {winprobality -= 30}");
//            }
//            else if (ch == 4)
//            {
//                Console.WriteLine($"You have entered {ch} your energy level is {Energylevel += 4} and your win probility is {winprobality += 40}");
//            }
//            else if (ch == 5)
//            {
//                Console.WriteLine($"You have entered {ch} your energy level is {Energylevel += 5} and your win probility is {winprobality += 50}");
//            }
//            else if (ch == 6)
//            {
//                Console.WriteLine($"You have entered {ch} your energy level is {Energylevel -= 1} and your win probility is {winprobality -= 60}");
//            }
//            else if (ch == 7)
//            {
//                Console.WriteLine($"You have entered {ch} your energy level is {Energylevel += 1} and your win probility is {winprobality += 70}");
//            }
//            else if (ch == 8)
//            {
//                Console.WriteLine($"You have entered {ch} your energy level is {Energylevel -= 2} and your win probility is {winprobality -= 20}");
...
//            else if (ch == 10)
//            {
//                Console.WriteLine($"You have entered {ch} your energy level is {Energylevel += 10} and your win probility is {winprobality += 100}");
//            }
//        }
